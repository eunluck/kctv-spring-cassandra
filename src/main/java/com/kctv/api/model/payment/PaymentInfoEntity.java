package com.kctv.api.model.payment;
...
public class PaymentInfoEntity {
    ...
    @Column("end_dt")
    private Date endDt;
    @Column("friend_email_refer_me")
    private String friendEmailReferMe;


    public PaymentInfoEntity(UUID userId, String appPaymentCode, Date createDt){
       this.userId = userId;
       this.appPaymentCode = appPaymentCode;
       this.createDt = createDt;
    }

    public PaymentInfoEntity(UUID userId, String appPaymentCode, Date createDt,Date endDt){
        this.userId = userId;
        this.appPaymentCode = appPaymentCode;
        this.createDt = createDt;
        this.endDt = endDt;
    ...
    public PaymentInfoEntity(String appPaymentCode, UUID userId, String friendEmailReferMe, Date createDt){
        this.userId = userId;
        this.appPaymentCode = appPaymentCode;
        this.createDt = createDt;
        this.friendEmailReferMe = friendEmailReferMe;
    }
