...
public enum TagGroup {
    ...
    tag7("신규", Lists.newArrayList(),1L);
    private String tagType;
    private List<String> tagName;
    private long point;
    private Function<String,Long> expression;
    ...
    public static long findByTagPoint(String tag){
        ...
        return Arrays.stream(TagGroup.values()).filter(tagGroup -> tagGroup.hasTagName(tag)).findAny().orElse(tag7).point;
    }
